...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-300 to-teal-300">
      <h1 className="text-5xl font-bold text-white mb-4 sm2xl:text-3xl">
        Fruit.Ai
      </h1>
      <p className="text-xl text-white mb-8 sm2xl:text-base">"Be Healthy"</p>

      <div className="flex flex-wrap justify-center gap-7 mx-5">
        <div
          onClick={() => navigate("/chat")}
          className="group flex items-center justify-center w-32 h-32 bg-green-200 rounded-lg shadow-lg cursor-pointer hover:bg-green-400 ease-in-out duration-300 sm2xl:w-28 sm2xl:h-28"
        >
        ...
        <div
          ...
          className="flex items-center justify-center w-32 h-32 bg-blue-200 rounded-lg shadow-lg cursor-pointer hover:bg-blue-300 ease-in-out duration-300 sm2xl:w-28 sm2xl:h-28"
        >
          <img
        ...
        <div
          ...
          className="group flex items-center justify-center w-32 h-32 bg-purple-300 rounded-lg shadow-lg cursor-pointer hover:bg-purple-400 ease-in-out duration-300 sm2xl:w-28 sm2xl:h-28"
        >
