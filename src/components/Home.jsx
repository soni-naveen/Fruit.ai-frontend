...
const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-300 to-teal-300">
      <h1 className="text-4xl font-medium text-white mb-4 sm2xl:text-3xl">Fruit.Ai</h1>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="flex items-center justify-center w-32 h-32 bg-blue-200 rounded-lg shadow-lg cursor-pointer hover:bg-blue-300 ease-in-out duration-300 sm2xl:w-28 sm2xl:h-28">
          <img src={GoogleTranslator} alt="Translate" className="h-12 w-12 sm2xl:h-10 sm2xl:w-10" />
        </div>
        ...
        <div className="group flex items-center justify-center w-32 h-32 bg-pink-200 rounded-lg shadow-lg cursor-pointer hover:bg-pink-300 ease-in-out duration-300 sm2xl:w-28 sm2xl:h-28">
