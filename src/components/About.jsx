...
const AboutPage = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-purple-200 to-blue-200 smxl:items-end">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-lg overflow-hidden p-9 text-center sm:max-w-sm smxl:p-10 smxl:max-w-full smxl:rounded-b-none animate__animated animate__fadeInUp">
        ...
        <button
          ...
          className="px-20 py-2 bg-black text-white rounded-full hover:bg-gray-900 transition duration-300 ease-in-out sm:px-32 sm:py-3"
        >
          Home
        </button>
      </div>
