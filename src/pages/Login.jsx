...
function Login() {
  ...
  return (
    <>
      <div className="flex justify-evenly h-screen items-center md1:flex-col md1:justify-center md1:gap-10 md1:my-10 sm:my-0">
            ...
            >
              <label className="w-full">
                ...
                <input
                  ...
                  className="w-[300px] px-3 py-3 bg-teal-50 text-black border border-gray-400 outline-none rounded-md text-sm sm:w-[250px] sm:py-2.5"
                />
              </label>
              ...
              <button className="rounded-sm text-white bg-teal-400 font-semibold hover:bg-teal-500  mt-5 py-1.5 sm:mt-4">
                Login
              </button>
